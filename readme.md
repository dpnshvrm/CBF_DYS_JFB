...
```
python train.py --problem douvle_integrator_single  --epochs 1000 --lr_decay 400

python train.py --problem douvle_integrator_multi   --epochs 5000 --lr_decay 800 --hidden_dim 128
